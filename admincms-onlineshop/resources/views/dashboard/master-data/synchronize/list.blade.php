                        ...
                        <form id="formFilter">
                            <div class="row justify-content-end">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-2 col-xl-2">
                                    <button type="button" class="btn btn-warning btn-block" id="iSyncronise" >Syncronise</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-footer bg-whitesmoke">
                        ...
                        <div class="row justify-content-end">
                                ...
                                <button type="button" id="btnEdit" class="btn btn-block btn-primary" disabled>
                                    <i class="fas fa-pencil-alt mr-2"></i>syncronise 
                                </button>
                                </div>
                            </div>
                    </div>
     ...
     const formFilter = $('#formFilter');
        ...
        $(document).ready(function () {
            let listTable = new Tabulator("#listTable", {
                ...
                pagination: "remote",
                ajaxFiltering: true,
                ajaxURL: "{{ url('master/data/synchronize/list/data') }}",
                ajaxConfig: {
                    method: "POST",
                    headers: {
            ...
            btnEdit.click(function (e) {
                ...
                window.location = '{{ url('master/data/buku/edit') }}/'+id;
            });

            iSyncronise.click(function (e) {
                e.preventDefault();
                window.location = '{{ url('master/data/synchronize/submit') }}';
            });
