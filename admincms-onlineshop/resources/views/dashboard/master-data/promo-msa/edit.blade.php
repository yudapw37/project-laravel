            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    ...
                    <form id="formData">
                        ...
                        <input type="hidden" id="code_promo" name="code_promo" value="{{$data->code_promo}}">
                        <div class="card-body">
                        <div class="row">
                                ...
                                <input id="iNamaPromo" name="namaPromo" type="text" class="form-control" value="{{$data->nama_promo}}" autofocus required>
                            </div>
                            <div class="form-group">
                                <label for="iHargaJadi">Harga Jadi</label>
                                <input id="iHargaJadi" name="iHargaJadi" type="text" class="form-control" value="{{$data->harga_jadi}}" autofocus required>
                            </div>
                            <div class="form-group">
        ...
        $(document).ready(function () {
            ...
            formData.submit(function (e) {
                ...
                let formData = new FormData();
                 ...
                 formData.append('code_promo', iNamaPromo.val());
                 formData.append('namaPromo', iNamaPromo.val());
                 formData.append('code_promo', code_promo.val());
                    ...
                    success: function (response) {
                        if (response === 'success') {
                            Swal.fire({
                                ...
                                timer: 1000,
                                onClose: function () {
                                    window.location = '{{ url('master/data/promo/list') }}';
                                }
                            });
                        } else {
                    ...
                    success: function (response) {
                        if (response === 'success') {
                            Swal.fire({
                                ...
                                timer: 1000,
                                onClose: function () {
                                    $('#listTable2').DataTable().ajax.reload();
                                        }
                            });
                        } 
