            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Tambah Data Kategori Promo</h4>
                    </div>
                    <form id="formData">
                        ...
                        <div class="form-group">
                                ...
                                <input id="kategori" name="kategori" type="text" class="form-control" autofocus required>
                            </div>
                    ...
                    success: function (response) {
                        if (response === 'success') {
                            Swal.fire({
                                ...
                                timer: 1000,
                                onClose: function () {
                                    window.location = '{{ url('master/data/promo-kategori') }}';
                                }
                            });
                        } else {
