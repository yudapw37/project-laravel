@extends('ui.layout.mainpendidikan')
...
<?php $cat= $varType;?>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                        <ul class="nav navbar-nav main-menu">
                            ...
                            <li class="page-scroll"><a href="#team">Fasilitas</a>
                            </li>
                            <li class="page-scroll"><a href="#services">Jam Belajar</a>
                            </li>
                            <li class="page-scroll"><a href="#skills">Ekstrakulikuler</a>
                            </li>
                            <li class="page-scroll"><a href="#features">Prestasi</a>
                            </li>
                ...
                <div class="intro-body">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="slide-intro">
                                    <h1><?php if($cat == 1){echo "KB/RA";}elseif($cat==2){echo "SDIP";}else{echo "MTS";} ?> <span style="color:#0fa285">YPIHMSUBANDI</span></h1>
    ...
    <section id="about-1" class="section-content">
      <div class="container">
        <div class="row mbxxl">
          <div class="col-lg-12">
            <h2 class="section-heading">TENTANG <span><?php if($cat == 1){echo "KB/RA";}elseif($cat==2){echo "SDIP";}else{echo "MTS";} ?> YPIHMSUBANDI</span></h2>
            <div class="line"></div>
            <p class="section-description" style="text-align:justify;padding: 0 5% 30px!important;">
            <?php $text =
    ...
    <section id="team" class="section-content">
        <div class="container">
            <div class="row mbxxl">
                <div class="col-lg-12">
                    <h2 class="section-heading">Fasilitas <span><?php if($cat == 1){echo "KB/RA";}elseif($cat==2){echo "SDIP";}else{echo "MTS";} ?> YPIHMSUBANDI</span></h2>
                    <div class="line"></div>
    ...
    <section id="services" class="section-content">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h2 class="section-heading">Jam Belajar <span><?php if($cat == 1){echo "KB/RA";}elseif($cat==2){echo "SDIP";}else{echo "MTS";} ?> YPIHMSUBANDI</span></h2>
    ...
    <section id="skills" class="section-content">
        <div class="container">
            <div class="row mbxxl">
                <div class="col-lg-12">
                    <h2 class="section-heading">Ekstrakulikuler <span><?php if($cat== 1){echo "KB/RA";}elseif($cat==2){echo "SDIP";}else{echo "MTS";} ?> YPIHMSUBANDI</span></h2>
                    <div class="line"></div>
    ...
    <section id="features" class="section-content">
        <div class="container">
            <div class="row mbxxl">
                <div class="col-lg-12">
                    <h2 class="section-heading">Prestasi <span><?php if($cat == 1){echo "KB/RA";}elseif($cat==2){echo "SDIP";}else{echo "MTS";} ?> YPIHMSUBANDI</span></h2>
                    <!-- <div class="line"></div> -->
                    <p class="section-description">
