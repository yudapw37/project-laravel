...
class c_md_flashSale extends Controller
{
    ...
    public function edit($id) {
        ...
        ->select('ms_flashsale.id as id','ms_flashsale.id_buku as id_buku','ms_barang.judul_buku as judul_buku','ms_flashsale.harga_jadi as harga_jadi','ms_flashsale.stock as stock')
        ...
        try {
            ...
            if ($type == 'baru') {    
                ...
                ->first();
                        ...
                        $l = new mod_md_ms_kategori_promo_trn();
                        $l->id_kategori = '4';
                        $l->id_promo = $kode;
                        $l->save();
